...
The Raspberry Pi Pico at the bottom served as a data logger, measuring the voltage of the sensor's battery. This was the only real let-down of the project since the battery life was pretty underwhelming. The sensor was not able to accumulate enough charge to last through the night, as can be seen in the soil moisture chart above.
